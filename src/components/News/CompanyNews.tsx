...
import { Building2, Search, User, Calendar, Clock } from "lucide-react"
import { companyNews } from "@/data/mock/news"
...
export function CompanyNews() {
  ...
  const filteredArticles = companyNews.filter(
    (article) =>
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="اخبار شرکت"
        description="اخبار و اطلاعیه‌های داخلی شرکت سیورا"
        Icon={Building2}
      />
      ...
      <div className="relative max-w-md">
        ...
        <input
          type="text"
          placeholder="جستجو در اخبار شرکت..."
          value={searchTerm}
