...
export default function HelpDeskPage() {
  ...
  const handleSubmitTicket = () => {
    ...
    const newTicket = {
      ...
      title: newTitle.trim(),
      description: newDescription.trim() || "بدون توضیحات",
      priority: newPriority || "medium",
      status: "open",
      category: newCategory || "سایر",
      assignee: "تیم پشتیبانی",
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Input placeholder="عنوان مشکل یا درخواست" value={newTitle} onChange={(e) => setNewTitle(e.target.value)} />
              </div>
              <div>
                ...
                <Select value={newCategory} onValueChange={setNewCategory}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="سیستم">سیستم</SelectItem>
              ...
              <div className="md:col-span-2">
                ...
                <Textarea placeholder="توضیح کاملی از مشکل یا درخواست خود ارائه دهید..." rows={4} value={newDescription} onChange={(e) => setNewDescription(e.target.value)} />
              </div>
              <div className="md:col-span-2 flex gap-2">
                <Button onClick={handleSubmitTicket}>ارسال تیکت</Button>
